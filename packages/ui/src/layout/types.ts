...
export interface ILayoutIndexRouteObject
  extends ILayoutData,
    Omit<IndexRouteObject, "children" | "id" | "index"> {
  children?: undefined;
}
...
export type TLayoutRouteObject =
  | ILayoutIndexRouteObject
  | ILayoutNonIndexRouteObject;
...
export type TLayoutContentProps = Pick<ILayoutProps, "routes">;
